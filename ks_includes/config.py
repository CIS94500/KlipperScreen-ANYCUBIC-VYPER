        ...
        for section in config:
            ...
            if section == 'main':
                bools = (
                    ...
                    'autoclose_popups', 'use_dpms', 'use_default_menu', 'side_shutdown_shortcut', 'use-matchbox-keyboard',
    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            {"theme": {
                ...
                "value": "blue-dark", "callback": screen.restart_ks, "options": [
                    {"name": "blue-dark" + " " + _("(default)"), "value": "blue-dark"}]}},
            ...
            {"24htime": {"section": "main", "name": _("24 Hour Time"), "type": "binary",
                         "value": "True"}},
            {"side_shutdown_shortcut": {
                "section": "main", "name": _("Shutdown shortcut on sidebar"), "type": "binary",
                "value": "True", "callback": screen.toggle_shutdown_shortcut}},
            {"font_size": {
        ...
        themes = [
            ...
            if (not os.path.isfile(os.path.join(t_path, d))
                and d not in ("blue-dark", "printers"))
        ]
        themes.sort()
